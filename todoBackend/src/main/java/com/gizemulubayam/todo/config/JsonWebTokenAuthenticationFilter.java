...
public class JsonWebTokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jsonWebTokenGenerator.validateToken(jwt)) {

                final Long userId = jsonWebTokenGenerator.getUserIdFromJWT(jwt);

                final UserDetails userDetails = userService.findByUserId(userId);
